          ...
          <form>
            <div className="mx-[15%] md:mx-[5%]">
              <div className="flex flex-col md:flex-row gap-4 pt-8">
                ...
                <div className="flex flex-col md:flex-row gap-6 pt-2 md:pt-8">

                  <div className="flex flex-col">
                  <label for="name" className="text-[12px] md:text-[16px] leading-6 pb-1"> User role</label>
                  <select name="Role" id="role" value={userRole} onChange={(e)=>{setUserRole(e.target.value)}} required className="bg-[#D9D9D9] text-[11px] border-2 rounded-lg border-[#979699] w-[40vw] md:w-[327px] h-1/2 md:h-[38px] px-6 py-2 ">
                  ...
                  <div className="flex flex-col md:flex-row gap-4 pt-2 md:pt-8">
                    ...
                    <div className="flex gap-2 md:gap-6 pt-20 ">
                      <button className="text-white bg-[#0B1C2E] hover:text-[#0B1C2E] hover:bg-white hover:border-[#0B1C2E] border-2 rounded-lg border-[#979699] w-[42vw] md:w-[85%] h-1/2 md:h-[55px] px-6 py-2 -ml-6 md:ml-0 ">
                        Submit
                      </button>
