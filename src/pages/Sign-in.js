...
const Auth = () =>{
  ...
  return(
    <section className='w-screen'>
      ...
      {/*Sign-in form*/}
      <div className=" mx-auto items-center justify-center  border-2 rounded-[20px] shadow-xl h-fit mt-16  w-[80vw] md:h-[460px] md:w-[400px] ml-[10%] md:ml-[22%] lg:ml-[36%]">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center ">
          ...
          <div className="flex flex-col pt-4 md:pt-8">
            ...
            <div className="b" onClick={togglePassword}>
              {showPassword ?
                <BsEyeFill className="absolute cursor-pointer text-[26px] md:text-[32px] top-[355px] right-[90px] md:right-[300px] xl:right-[487px] md:top-[380px] pt-3 md:pt-2 md:mt-6"/> :
                <RiEyeCloseLine className="absolute cursor-pointer text-[26px] md:text-[32px] top-[355px] right-[90px] md:right-[300px] xl:right-[487px] md:top-[380px]  pt-3 md:pt-2 md:mt-6"/>
            }
            </div>
          </div>
