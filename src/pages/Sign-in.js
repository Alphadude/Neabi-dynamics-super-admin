        ...
        <form onSubmit={handleSubmit} className="flex flex-col justify-center items-center ">
          ...
          <div className="flex flex-col pt-4 md:pt-8">
            ...
            <div className="b" onClick={togglePassword}>
              {showPassword ?
                <BsEyeFill className="absolute cursor-pointer text-[26px] md:text-[32px] top-top-[355px] right-[90px] md:right-[41%] xl:right-[38%] md:top-[380px] pt-3 md:pt-2 md:mt-6"/> :
                <RiEyeCloseLine className="absolute cursor-pointer text-[26px] md:text-[32px] top-[355px] right-[90px] md:right-[41%] xl:right-[38%] md:top-[380px]  pt-3 md:pt-2 md:mt-6"/>
            }
            </div>
          </div>
